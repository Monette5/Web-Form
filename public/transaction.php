...
<body>
 ...
 <div class='banner'>
       <h1>PUT Request - Transactional</h1> 
 </div>
<div class="container">
    <form class="form-row" action="src/pds-transaction.php" method="post" id="putdata">
      <div class="row">
        <div class="col-md-6">
          <h3>Enter Information</h3>
            ...
            <div type="hidden" class="form-group">
              ...
              <input class="form-control" type="text" id="dataset" name="dataset" placeholder="Dataset">
            </div>
        ...
        <div class="col-md-8">
          <h3>Output</h3>
          <table id="infoTable1" class="table table-striped hidden-on-load" >
      <thead>
               <th class="table-column-title">Field</th>
               <th class="table-column-title">Value</th>
              </thead>

              <tbody id="table1-data"></tbody>
          </table>
        </div>
      </div>
    </div>
